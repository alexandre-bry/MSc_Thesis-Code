...
//     explicit OutlineAsEdges(const std::vector<std::vector<EdgeId>>
//     &polygons);
// };
...
//     // - Edge sequences are groups of successive edges, which are grouped
//     based
...
//     // - Outlines are a simple representation of multipolygons that is only
//     used
...
//     AllOutlines() = default;
//     AllOutlines(
//         const EdgeVector<Edge> &edges, const EdgeVector<EdgeId>
//         &prev_edge_ids, const EdgeVector<EdgeId> &next_edge_ids, const
//         EdgeSeqVector<EdgeSeq> &edge_seqs, const EdgeVector<EdgeSeqId>
//         &edge_id_to_edge_seq_id, const EdgeSeqVector<EdgeSeqId>
//         &prev_edge_seq_ids, const EdgeSeqVector<EdgeSeqId>
//         &next_edge_seq_ids, const EdgeSeqGroupVector<EdgeSeqGroup>
//         &edge_seq_groups, const EdgeSeqVector<EdgeSeqGroupId>
//         &edge_seq_id_to_edge_seq_group_id, const
//         OutlineVector<OutlineAsEdges> &outlines, const
//         EdgeSeqVector<OutlineId> &edge_seq_id_to_outline_id, const
//         OptimizationUnitVector<OptimizationUnit> &optim_units, const
//         EdgeSeqGroupVector<OptimizationUnitId>
//             &edge_seq_group_id_to_optim_unit_id);
...
//                   const std::vector<std::pair<EdgeId, EdgeId>>
//                   &intersections);
